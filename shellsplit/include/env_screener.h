...
#ifndef SHELL_ENV_SCREENER_POSTERIOR_THRESHOLD
#define SHELL_ENV_SCREENER_POSTERIOR_THRESHOLD 0.5
#endif

#ifndef SHELL_ENV_SCREENER_MIN_LENGTH
#define SHELL_ENV_SCREENER_MIN_LENGTH 24
#endif

/* --- RETURN CODES --- */

typedef enum {
  SHELL_ENV_SCREENER_OK = 0,
  SHELL_ENV_SCREENER_BUFFER_TOO_SMALL = 1,
  SHELL_ENV_SCREENER_ERROR = -1
 ...
 * @return                       SHELL_ENV_SCREENER_OK on success,
 * SHELL_ENV_SCREENER_BUFFER_TOO_SMALL if capacity too small (out_count has
 * minimum needed), SHELL_ENV_SCREENER_ERROR on error
 */
shell_env_screener_status_t
 ...
 */
size_t shell_env_screener_recommended_capacity(void);
